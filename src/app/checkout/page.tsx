...
const Checkout = () => {
  ...
  return (
    <div className="flex flex-col w-full lg:flex-row justify-between bg-[#fafafa]">
      ...
      <CartAndDeliveryOptions TOTAL_CART_ITEMS={TOTAL_CART_ITEMS} cartItems={cartItems}/>
      
      {/* right content: Order summary  */}
      <div className="lg:fixed py-8 right-0 w-full rounded-t-3xl lg:w-[35%] flex items-center px-8 xl:px-16 gap-5 flex-col lg:pt-5 h-full bg-lightGray">
      {/* product pricing */}
